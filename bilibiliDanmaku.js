...
(function() {
	...
	let code = setInterval(() => {
		...
		if (node && window.cid) {
            ...
            span.appendChild(document.createTextNode(' | '));
			span.appendChild(downloadCover);
